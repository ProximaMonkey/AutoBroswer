        ...
        public bool searchBroswer(string keyword)
        {
            ...
            foreach (HtmlElement searchBTN in elements)
            {
                ...
                if (className == "btn-search")
                {
                    ...
                    //Point p = GetElementPosition(searchBTN);// GetOffset(searchBTN);
                    //p.X += randX;
                    //p.Y += randY;
