namespace TaskBrowser
{
    ...
    {
        public bool _allowScrollWhileWaiting = TaskForm.ALLOWSCROLLWHILEWAITING;
        public ArrayList _AreaClicks;
        public int _clickCountPerIP = TaskForm.CLICKCOUNTPERIP;
        public int _clickIntervalTime = TaskForm.CLICKINTERVALTIME;
        public int _clickRate = TaskForm.CLICKRATE;
        ...
        {
            return ((((hour >= 0) && (hour < TaskForm.HOURSCOUNT)) && ((this._HourClicks != null) && (this._HourClicks.Count == TaskForm.HOURSCOUNT))) && (Convert.ToInt32(this._HourClicks[hour]) <= this._completedCount));
        }
        ...
        public void SetHourClick(ArrayList hourClicks)
        {
            ...
            if ((hourClicks != null) && (hourClicks.Count != TaskForm.HOURSCOUNT))
            {
                hourClicks.Clear();
                hourClicks = null;
            }
