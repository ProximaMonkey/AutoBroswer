namespace TaskBrowser
{
    ...
    public class UnsafeNativeMethods
    {
        ...
        [ComImport, InterfaceType((short) 2), TypeLibType((short) 0x1010), Guid("34A715A0-6587-11D0-924A-0020AFC7AC4D")]
        ...
        public interface IWebBrowser2
        {
            ...
            [DispId(0x1f5)]
            TaskBrowser.NativeMethods.OLECMDF QueryStatusWB([In] TaskBrowser.NativeMethods.OLECMDID cmdID);
            [DispId(0x1f6)]
            void ExecWB([In] TaskBrowser.NativeMethods.OLECMDID cmdID, [In] TaskBrowser.NativeMethods.OLECMDEXECOPT cmdexecopt, ref object pvaIn, IntPtr pvaOut);
            [DispId(0x1f7)]
